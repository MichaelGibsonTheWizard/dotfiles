  ...
  let $ = {
    ...
    f: {
      ...
      act: {
        ...
        showResults: r => {
          let i, p, img, thumb, mask, ft, ftDomain, ftDesc, description, ftDeets, avatar, pinner, cc, tation, note, board, saveButton, searchButton, logMe, noteColor, anno, grid;
            ...
            if (r.data.annotations.length) {
              ...
              for (i = 0; i < r.data.annotations.length; i = i + 1) {
                tation = $.f.make({'SPAN':{
                  ...
                  innerText: r.data.annotations[i],
